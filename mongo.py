...
data = {
    "name " : "rohan",
    "email" : "ro@gmail.com",
    "subject": ["data_science","big data","AI"]
}
...
collection = database['RA']
collection.insert_one(data)
collection.insert_many(list_of_records)


collection1 = database['roh']
...
# finnding perticular record
'''r1= collection.find({"name ":"rohan"})
for i in r1:
    print(i)'''

#finding greaater record than d
'''r2 = collection.find({"email":{"$gt":"d"}})
for i in r2:
    print(i)'''
